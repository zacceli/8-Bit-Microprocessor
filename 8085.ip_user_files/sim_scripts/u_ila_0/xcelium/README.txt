...
#
# Generated by export_simulation on Sat Jun 24 09:44:53 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './u_ila_0.sh' script.

./u_ila_0.sh -reset_run
...
./u_ila_0.sh -noclean_files

For more information on the script, please type './u_ila_0.sh -help'.
